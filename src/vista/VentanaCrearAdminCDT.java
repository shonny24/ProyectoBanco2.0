 ...
 * @author Juan Carlos
 */
public class VentanaCrearAdminCDT extends javax.swing.JFrame {
     ...
     * @param ban
     */
    public VentanaCrearAdminCDT(Banco ban,String id) {
        miBanco = ban;
        this.id = id;
        initComponents();
    ...
    private void jBAgregarCDTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAgregarCDTActionPerformed
        ...
        boolean agregarCDT = miCliente.agregarCDT(miCDT);
        miCliente.setNumeroBancario(numeroCDT);
...
//            VentanaCuentaUsuario.llenarTablaCDT();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaCrearAdminCDT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCrearAdminCDT(null,null).setVisible(true);
            }
        });
    }
