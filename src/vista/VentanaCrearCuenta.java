...
public class VentanaCrearCuenta extends javax.swing.JFrame {
     ...
     * @param ban
     */
    public VentanaCrearCuenta(Banco ban) {
        miBanco = ban;
        initComponents();
    ...
    private void jBCrearCuentaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBCrearCuentaActionPerformed
        ...
        if (validarDatos().equals("")) {
            ...
            if (jRadioAhorro.isSelected()) {
                ...
                boolean agregarAhorro = clienteSesion.agregarCuentaAhorro(miAhorro);
                //revisar lo hizo juank, los usuarios no tienen numeros bancario tienen cuentas...
                clienteSesion.setNumeroBancario(numeroAhorro);
                ...
                boolean agregarCorriente = clienteSesion.agregarCuentaCorriente(miCorriente);
                clienteSesion.setNumeroBancario(numeroCorriente);
                ...
                if (miEmpresa != null) {
                    ...
                    miNomina = new Nomina(miEmpresa, clienteSesion, 0, numeroNomina,fechaCreacion);
                    
                    boolean agregarNomina = clienteSesion.agregarCuentaNomina(miNomina);
...
//        }        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VentanaCrearCuenta(null).setVisible(true);
            }
        });
    }
